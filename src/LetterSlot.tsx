  ...
  ({ setLetter, letter, onKeyPress }, ref) => {
    ...
    return (
      <div className="flex flex-col gap-2">
        <div
          className={`flex items-center justify-center text-stone-300 font-extrabold rounded-none aspect-square w-16 h-16 outline-0 text-3xl caret-transparent ${bgColor} focus:border-solid focus:border-2 focus:border-white focus:shadow-stone-500 focus:shadow-inner rounded-sm`}
